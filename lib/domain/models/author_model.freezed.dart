...
abstract class $AuthorModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String firstName, String lastName, String picture});
}
...
class _$_AuthorModel extends _AuthorModel {
  _$_AuthorModel(this.id, this.firstName, this.lastName, this.picture)
      : super._();
  ...
  @override
  String toString() {
    return 'AuthorModel(id: $id, firstName: $firstName, lastName: $lastName, picture: $picture)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, firstName, lastName, picture);
...
abstract class _AuthorModel extends AuthorModel {
  factory _AuthorModel(final int id, final String firstName,
      final String lastName, final String picture) = _$_AuthorModel;
